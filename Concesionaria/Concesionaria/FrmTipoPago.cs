...
{
    public partial class FrmTipoPago : FrmBase
    {
        public FrmTipoPago()
        {
            InitializeComponent();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            Clases.cFunciones fun = new Clases.cFunciones();
            if (txtCodigo.Text == "")
                fun.GuardarNuevoGenerico(this, "TipoPago");
            else
                fun.ModificarGenerico(this, "TipoPago", "CodTipoPago", txtCodigo.Text);
        ...
        private void btnAbrir_Click(object sender, EventArgs e)
        {
            ...
            //nombre de la tabla, 
            Principal.TablaPrincipal = "TipoPago";
            Principal.OpcionesColumnasGrilla = "CodTipoPago; Nombre";
        ...
        private void form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (Principal.CodigoPrincipalAbm != null)
            {
                if (Principal.CodigoPrincipalAbm != "")
                {
                    ...
                    if (Principal.CodigoPrincipalAbm != "")
                        fun.CargarControles(this, "TipoPago", "CodTipoPago", txtCodigo.Text);
                    Grupo.Enabled = false;
                    return;
                }
