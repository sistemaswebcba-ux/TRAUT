...
{
    public partial class FrmListadoDocumentosAnteriores : Form
    {
        public FrmListadoDocumentosAnteriores()
        {
            InitializeComponent();
        }
        ...
        private void FrmListadoDocumentosAnteriores_Load(object sender, EventArgs e)
        {
        ...
        private void btnCobroCheque_Click(object sender, EventArgs e)
        {
            ...
            string CodGrupo = Grilla.CurrentRow.Cells[10].Value.ToString();
            Principal.CodigoPrincipalAbm = CodGrupo.ToString();
            FrmCobroDocumentosAnteriores form = new FrmCobroDocumentosAnteriores();
            form.ShowDialog();
        }
    }
}
